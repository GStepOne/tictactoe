!function (t, e) {
    ...
    return function (t) {
        ...
        (function (t) {
            ...
            function c(t, e, n) {
                for (var r = new Array(t.length), o = l(t.length, n), i = 0; i < t.length; i++) !function (t, n, o) {
                    e(n, function (e, n) {
                        r[t] = n, o(e, r)
                    })
                }(i, t[i], o)
            ...
            var p, u = n(27), h = n(13), f = n(19), l = n(18), d = n(28);
            t && t.ArrayBuffer && (p = n(21));
            ...
            var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = u(v),
                k = {type: "error", data: "parser error"}, w = n(22);
            e.encodePacket = function (e, n, i, a) {
                ...
                try {
                    ...
                    for (var a = new Uint8Array(n.data), c = new Array(a.length), p = 0; p < a.length; p++) c[p] = a[p];
                ...
                var s = h(t);
                return n && s ? w && !m ? e.encodePayloadAsBlob(t, r) : e.encodePayloadAsArrayBuffer(t, r) : t.length ? void c(t, i, function (t, e) {
                    return r(e.join(""))
                }) : r("0:")
                ...
                for (var i, s, a = "", c = 0, p = t.length; c < p; c++) {
                    ...
                    if (":" === u) {
                        ...
                        if (s = t.substr(c + 1, i), a != s.length) return r(k, 0, 1);
                        if (s.length) {
                            if (o = e.decodePacket(s, n, !1), k.type === o.type && k.data === o.data) return r(k, 0, 1);
                ...
                for (var o = t, i = []; o.byteLength > 0;) {
                    for (var s = new Uint8Array(o), a = 0 === s[0], c = "", p = 1; 255 !== s[p]; p++) {
                        if (c.length > 310) return r(k, 0, 1);
                        c += s[p]
                    }
                    ...
                    if (a) try {
                        ...
                        u = "";
                        for (var p = 0; p < h.length; p++) u += String.fromCharCode(h[p])
                    }
                    i.push(u), o = f(o, c)
                }
                var l = i.length;
        ...
        function a(t) {
            ...
            if (null == e.types[r.type]) return u("unknown packet type " + r.type);
            ...
            if (t.charAt(++n)) {
                var a = c(t.substr(n));
                if (!(!1 !== a && (r.type === e.ERROR || d(a)))) return u("invalid payload");
                r.data = a
            }
            return r
        }
        ...
        var h = (n(1)("socket.io-parser"), n(2)), f = n(13), l = n(29), d = n(6), y = n(16);
        e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = r, e.Decoder = s, r.prototype.encode = function (t, n) {
            if (t.type !== e.EVENT && t.type !== e.ACK || !f(t.data) || (t.type = t.type === e.EVENT ? e.BINARY_EVENT : e.BINARY_ACK), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type) i(t, n); else {
                n([o(t)])
            }
        ...
        function r(t, e) {
            ...
            t && "object" === (void 0 === t ? "undefined" : o(t)) && (e = t, t = void 0), e = e || {}, e.path = e.path || "/socket.io", this.nsps = {}, this.subs = [], this.opts = e, this.reconnection(!1 !== e.reconnection), this.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e.reconnectionDelay || 1e3), this.reconnectionDelayMax(e.reconnectionDelayMax || 5e3), this.randomizationFactor(e.randomizationFactor || .5), this.backoff = new f({
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            }, i = n(24), s = n(8), a = n(2), c = n(4), p = n(9), u = n(10), h = (n(1)("socket.io-client:manager"), n(14)),
            f = n(20), l = Object.prototype.hasOwnProperty;
        t.exports = r, r.prototype.emitAll = function () {
            ...
            var o = p(n, "open", function () {
                ...
                if (r.cleanup(), r.readyState = "closed", r.emitAll("connect_error", e), t) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, i = n(4), s = n(2), a = n(30), c = n(9), p = n(10), u = (n(1)("socket.io-client:socket"), n(7));
        t.exports = r;
        var h = {
            connect: 1,
            connect_error: 1,
        ...
        s(r.prototype), r.prototype.subEvents = function () {
            ...
            if ("/" !== this.nsp) if (this.query) {
                var t = "object" === o(this.query) ? u.encode(this.query) : this.query;
            ...
            return function () {
                if (!n) {
                    n = !0;
                    var r = a(arguments);
                    e.packet({type: i.ACK, id: t, data: r})
                }
            }
        ...
        (function (e) {
            ...
            var o = n(6), i = Object.prototype.toString,
        ...
        (function (e) {
            function r(t, n) {
                var r = t;
                n = n || e.location, null == t && (t = n.protocol + "//" + n.host), "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (t = void 0 !== n ? n.protocol + "//" + t : "https://" + t), r = o(t)), r.port || (/^(http|ws)$/.test(r.protocol) ? r.port = "80" : /^(http|ws)s$/.test(r.protocol) && (r.port = "443")), r.path = r.path || "/";
                var i = -1 !== r.host.indexOf(":"), s = i ? "[" + r.host + "]" : r.host;
                return r.id = r.protocol + "://" + s + ":" + r.port, r.href = r.protocol + "://" + s + (n && n.port === r.port ? "" : ":" + r.port), r
            }

            var o = n(15);
            n(1)("socket.io-client:url");
            t.exports = r
        }).call(e, n(0))
    }, function (t, e) {
        function n(t, e, n) {
        ...
        t.exports = n(25), t.exports.parser = n(3)
    }, function (t, e, n) {
        (function (e) {
            function r(t, n) {
            ...
            var i = n(12), s = n(2), a = (n(1)("engine.io-client:socket"), n(14)), c = n(3), p = n(15), u = n(7);
            t.exports = r, r.priorWebsocketSuccess = !1, s(r.prototype), r.protocol = c.protocol, r.Socket = r, r.Transport = n(11), r.transports = n(12), r.parser = n(3), r.prototype.createTransport = function (t) {
                var e = o(this.query);
                ...
                function e() {
                    ...
                    u || (p.send([{type: "ping", data: "probe"}]), p.once("packet", function (t) {
                        if (!u) if ("pong" === t.type && "probe" === t.data) {
                            if (h.upgrading = !0, h.emit("upgrading", p), !p) return;
                            r.priorWebsocketSuccess = "websocket" === p.name, h.transport.pause(function () {
                                u || "closed" !== h.readyState && (c(), h.setTransport(p), p.send([{type: "upgrade"}]), h.emit("upgrade", p), p = null, h.upgrading = !1, h.flush())
                            })
                        } else {
                            var e = new Error("probe error");
                            e.transport = p.name, h.emit("upgradeError", e)
                        }
                    }))
                }

                function n() {
                    u || (u = !0, c(), p.close(), p = null)
                }

                function o(t) {
                    var e = new Error("probe error: " + t);
                    e.transport = p.name, n(), h.emit("upgradeError", e)
                }
                ...
                function c() {
                    p.removeListener("open", e), p.removeListener("error", o), p.removeListener("close", i), h.removeListener("close", s), h.removeListener("upgrading", a)
                }

                var p = this.createTransport(t, {probe: 1}), u = !1, h = this;
                r.priorWebsocketSuccess = !1, p.once("open", e), p.once("error", o), p.once("close", i), this.once("close", s), this.once("upgrading", a), p.open()
            }, r.prototype.onOpen = function () {
                if (this.readyState = "open", r.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t])
            }, r.prototype.onPacket = function (t) {
                ...
                r.priorWebsocketSuccess = !1, this.emit("error", t), this.onClose("transport error", t)
        ...
        function r(t) {
            this.options = t, o.call(this, t)
        }

        var o = n(11), i = n(3), s = n(7), a = n(23), c = n(32);
        n(1)("engine.io-client:wxwebsocket");
        t.exports = r, a(r, o), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function () {
            var t = this.options, e = this.uri();
            wx.connectSocket({url: e, header: t.extraHeaders, protocols: t.protocols}), this.addEventListeners()
            ...
            return this.port && ("wss" === e && 443 !== Number(this.port) || "ws" === e && 80 !== Number(this.port)) && (n = ":" + this.port), this.timestampRequests && (t[this.timestampParam] = c()), this.supportsBinary || (t.b64 = 1), t = s.encode(t), t.length && (t = "?" + t), e + "://" + (-1 !== this.hostname.indexOf(":") ? "[" + this.hostname + "]" : this.hostname) + n + this.path + t
        }
    }, function (t, e) {
        ...
        (function (t, r) {
            ...
            !function (i) {
                ...
                function a(t) {
                    for (var e, n = t.length, r = -1, o = ""; ++r < n;) e = t[r], e > 65535 && (e -= 65536, o += k(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += k(e);
                    return o
                }
                ...
                function u(t, e) {
                    ...
                    var n = "";
                    return 0 == (4294965248 & t) ? n = k(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (c(t, e) || (t = 65533), n = k(t >> 12 & 15 | 224), n += p(t, 6)) : 0 == (4292870144 & t) && (n = k(t >> 18 & 7 | 240), n += p(t, 12), n += p(t, 6)), n += k(63 & t | 128)
                }
                ...
                function l(t) {
                    ...
                    if (192 == (224 & e)) {
                        if (n = f(), (i = (31 & e) << 6 | n) >= 128) return i;
                        throw Error("Invalid continuation byte")
                    }
                    if (224 == (240 & e)) {
                        if (n = f(), r = f(), (i = (15 & e) << 12 | n << 6 | r) >= 2048) return c(i, t) ? i : 65533;
                        throw Error("Invalid continuation byte")
                    }
                    if (240 == (248 & e) && (n = f(), r = f(), o = f(), (i = (7 & e) << 18 | n << 12 | r << 6 | o) >= 65536 && i <= 1114111)) return i;
                ...
                function d(t, e) {
                    e = e || {};
                    var n = !1 !== e.strict;
                    m = s(t), v = m.length, b = 0;
                    for (var r, o = []; !1 !== (r = l(n));) o.push(r);
                    return a(o)
                }

                var y = "object" == typeof e && e,
                    g = ("object" == typeof t && t && t.exports, "object" == typeof r && r);
                var m, v, b, k = String.fromCharCode, w = {version: "2.1.2", encode: h, decode: d};
                void 0 !== (o = function () {
                    return w
        ...
        (function (t) {
            ...
            var i = n(6), s = n(16), a = Object.prototype.toString,
        ...
        function r(t, e) {
            ...
            var n, r = i(t), s = r.source, p = r.id, u = r.path, h = c[p] && u in c[p].nsps,
                f = e.forceNew || e["force new connection"] || !1 === e.multiplex || h;
            return f ? n = a(s, e) : (c[p] || (c[p] = a(s, e)), n = c[p]), r.query && !e.query && (e.query = r.query), n.socket(r.path, e)
        }
        ...
        n(1)("socket.io-client");
        t.exports = e = r;
        var c = e.managers = {};
        e.protocol = s.protocol, e.connect = r, e.Manager = n(5), e.Socket = n(8)
    }])
});
