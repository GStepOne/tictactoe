...
class Menu extends Phaser.State {
    ...
    initMenu() {
        //监听onShow 事件，以允许用户最小化小游戏后 通过点击邀请卡片加入房间
    ...
    create() {
        ...
        if (go.launchRoomId) {
            ...
            //否则显示主菜单
            // 但仍监听 onShow 事件，以允许用户用最小化小游戏后通过点击邀请卡片加入房间
            // wx.onShow(this.handleOnShow);
            // //显示主菜单
            // addMenu();
            this.initMenu()
